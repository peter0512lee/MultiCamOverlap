...
gt_dir = 'C:/Users/u1607/Development/MultiCamOverlap/dataset/ground_truth/' + player
experiment_dir = 'C:/Users/u1607/Development/MultiCamOverlap/experiments_alpha/' + player
...
visual_root = 'C:/Users/u1607/Development/MultiCamOverlap/UI/data/'
...
def main():
    ...
    for current_frame in range(startFrame, endFrame):
        ...
        trajectory = cv2.imread('C:/Users/u1607/Development/MultiCamOverlap/UI/data/BasketballCourt.png')
